...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(environ.get("API_ID", '26183755'))
    API_HASH = str(environ.get("API_HASH", '7b7cfa427476172beb5ef3815209b747'))
    BOT_TOKEN = str(environ.get("BOT_TOKEN", '7330343474:AAHQ0SN-0qebEgQvH0bs94okjvOfFTl5Zvw'))
    SLEEP_THRESHOLD = int(environ.get("SLEEP_THRESHOLD", "60"))  # 1 minte
    WORKERS = int(environ.get("WORKERS", "6"))  # 6 workers = 6 commands at once
    BIN_CHANNEL = int(
        environ.get("BIN_CHANNEL", '-1002358747296')
    ...
    DATABASE_URL = str(environ.get('DATABASE_URL', 'mongodb+srv://muiz123:muiz123AHMED@cluster0.x8pxe.mongodb.net/?retryWrites=true&w=majority'))
    UPDATES_CHANNEL = str(environ.get('UPDATES_CHANNEL', "Teleservices_Api"))
    OWNER_ID = int(environ.get('OWNER_ID', '6334683599'))
